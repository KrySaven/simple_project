@extends('layouts.app')
@section('title',__('app.income_report'))
@section('content')
    <style>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>@lang('app.income_report')</h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            {!! Form::open(array('route' => 'income_report' , 'method' => 'GET')) !!}
                            ...
                            <div class="table table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr class="head_center">
                                        ...
                                        <th>@lang('app.date')</th>
                                        <th>@lang('app.name')</th>
                                        <th>@lang('app.group_income')</th>
                                        <th>@lang('app.description')</th>
                                        <th>@lang('app.income_by')</th>
                                    ...
                                    @php
                                       ...
                                       // $total_amount_riel=0;
                                        $owed_color = '';
                                    @endphp
                                    @foreach($income_report as $key => $row)
                                        @php
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->name }}</td>
                                            <td>{{ isset($row->group_income->name)?$row->group_income->name:'' }}</td>
