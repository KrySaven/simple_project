        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                          {!! Form::model($row, array('route' => array('color.update', $row->id), 'files'=>true)) !!}
                        {{-- <h3>@lang('app.create_color')</h3> --}}
                        <fieldset>
                            <div class="body">
                                <div class="row" style="display: flex;justify-content: center;">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group colorpicker">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" value="{{ $row->color_code }}" name="color_code">
                                            </div>
