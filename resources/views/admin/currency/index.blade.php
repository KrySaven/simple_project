        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header btnAdd">
                    <h2>@lang('app.list_currency')</h2>
                    @php
                        $UserPermision = MyHelper::UserPermision();
                        $checkisadmin = MyHelper::checkisadmin();
                    @endphp
                    @if(isset($checkisadmin) || isset($UserPermision['currency.create']))
                        <a href="{{ route('currency.create') }}" class="btn bg-green waves-effect">
                ...
                <div class="body">
                     <div class="row clearfix" style="margin-bottom: 10px;">
                        {!! Form::open(array('route' => 'currencies' , 'method' => 'GET')) !!}
                        <div class="col-md-6">
                            <b>@lang('app.search')</b>
                    ...
                    <div class="table-responsive">
                            ...
                            @forelse ($currency as $key => $row)
                                <tr>
                                    ...
                                    <div class="button_demo">
                                        <a href="{{route('currency.edit',['id'=>$row->id])}}"><button type="button" class="btn bg-green waves-effect"><i class="material-icons" style=" top: 0px;">mode_edit</i></button></a>
                                        <a onclick="deletes(this);" urls="{{route('currency.destroy',['id'=>$row->id])}}">
                        ...
                        <div class="col-md-12 pull-right">
                            {{ $currency->appends(Request::get('page'))->links()}}
                        </div>
                    </div>
                </div>
            </div>
