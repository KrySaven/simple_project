@extends('layouts.app')
@section('title',__('app.edit_district'))
@section('content')
<div class="container-fluid">
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>@lang('app.edit_district')</h2>
                </div> 
                <div class="body">
                    {!! Form::model($district, ['route' => ['district.update', $district->dis_id]]) !!}
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-float">
                                <div>
                                    <label class="form-label">@lang('District Name English')</label>
                                </div>
                                <div class="form-line">
                                    {{Form::text('district_name',null,['class'=>'form-control', 'placeholder'=>"District Name English"])}}
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-float">
                                <div>
                                    <label class="form-label">@lang('District Name Khmer')</label>
                                </div>
                                <div class="form-line">
                                    {{Form::text('district_namekh',null,['class'=>'form-control', 'placeholder'=>"District Name Khmer"])}}
                                </div>
