    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    {!! Form::model($row, array('route' => array('product.update', $row->id), 'files'=>true)) !!}
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        ...
                                        <span class="invalid-feedback" role="alert">
                                            <label id="category_id-error" class="error" for="category_id">{{
                                                $errors->first('category_id') }}</label>
                                        </span>
                                        @endif
                                    </div>
                                    <div class="form-group form-float">
                                        ...
                                        {!! Form::select('unit_id', $units, null, ['class' => 'form-control show-tick',
                                        'data-live-search' => 'true']) !!}
                                        @if ($errors->has('unit_id'))
                                        <span class="invalid-feedback" role="alert">
                                            <label id="unit_id-error" class="error" for="unit_id">{{
                                                $errors->first('unit_id') }}</label>
                                        </span>
                                        @endif
                                    </div>

                                    <div class="form-group form-float">
                                        <label class="form-label">@lang('app.code')<span class="required"
                                        ...
                                        <span class="invalid-feedback" role="alert">
                                            <label class="error" for="code_product">{{ $errors->first('code_product')
                                                }}</label>
                                        </span>
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <label class="form-label">@lang('app.price')<span class="required"
                                                style="color:red">*</span></label>
                                        <div class="form-line">
                                ...
                                <div class="col-sm-6">
                                    <label class="form-label">@lang('app.color')</label>
                                    <select class="form-control show-tick" multiple="" name="color_id[]" required>
                                        <optgroup label="Condiments" data-max-options="20">
                                            @php
                                            $selecteds = sizeof($selecteds) ? $selecteds : array();
                                            @endphp
                                            @foreach($colors as $color)
                                            @if (in_array($color->id, $selecteds))
                                    ...
                                    <span class="invalid-feedback" role="alert">
                                        <label id="color-error" class="error" for="color">{{ $errors->first('color_id')
                                            }}</label>
                                    </span>
                                    @endif
                                    <div class="form-group form-float">
                                    ...
                                    <div style="display: flex;">
                                        <div class="form-group form-float">
                                            ...
                                            <div style="width: 100px; height: 100px; position: relative;">
                                                <img class="img_one" id="img_cus" src="{{ $image }}" alt="" width="100"
                                        ...
                                        <div class="form-group form-float">
                                                ...
                                                <div style="width: 100px; height: 100px; position: relative;">
                                                    <div>
                                                        ...
                                                        <span class="number_of" id="number_files">{{ $pdfs }}</span>
                                                    </div>
                                                    {!! Form::file('pdfFiles[]', [
                                                        'multiple',
