        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        {!! Form::model($supplier, ['route' => ['supplier.update', $supplier->id], 'files' => true]) !!}
                        <fieldset>
                            <div class="row">
                                <div class="col-sm-6">
                                   <h3>@lang('app.personal_info')</h3>
                                    <div class="form-group form-float">
                                        <div>
                                            <label class="form-label">@lang('app.currency')<span class="required" style="color:red"> *</span></label>
                                        </div>
                                        ...
                                        <span class="invalid-feedback" role="alert">
                                            <label id="currency_id-error" class="error" for="currency_id">{{ $errors->first('currency_id') }}</label>
                                        </span>
                                        @endif
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label">@lang('app.name_en')<span class="required" style="color:red"> *</span></label>
                                        </div>
                                        @if ($errors->has('name'))
                                        <span class="invalid-feedback" role="alert">
                                   ...
                                   <h3>@lang('app.supplier_credential')</h3>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label">@lang('app.phone')<span class="required" style="color:red">*</span></label>
                                        </div>
                                        @if ($errors->has('phone'))
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-sm-4">
                                        @php
                                            $profile = '';
                                            if (file_exists($supplier->profile)) {
                                                $profile = asset($supplier->profile);
                                            } else {
                                                $profile = asset('images/noimage.png');
                                            }
                                            $identity = '';
                                            if (file_exists($supplier->identity)) {
                                                $identity = asset($supplier->identity);
                                            } else {
                                                $identity = asset('images/no_card.png');
                                            }
                                            $business = '';
                                            if (file_exists($supplier->business)) {
                                                $business = asset($supplier->business);
                                            } else {
                                                $business = asset('images/no_card.png');
                                            }
                                        @endphp
                                        <div class="form-group form-float">
                                            <div>
                                            ...
                                            <div style="width: 100px; height: 100px; position: relative;">
                                                <img class="img_one" id="img_cus" src="{{ $profile }}"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-float">
                                            ...
                                            <div style="width: 100px; height: 100px; position: relative;">
                                                <img class="img_one" id="img_bus" src="{{ $business }}"
                                                    alt="" width="100" height="100"
                                                    style="border-radius: 5px;">
                                                {!! Form::file('business', [
                                                    'accept' => 'image/jpeg , image/jpg, image/gif, image/png',
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-float">
                                            ...
                                            <div style="width: 150px; height: 100px; position: relative;">
                                                <img class="img_one" id="img_identity" src="{{ $identity }}"
                                                    alt="" width="150" height="100"
                                                    style="border-radius: 5px;">
                                                {!! Form::file('identity', [
                                                    'accept' => 'image/jpeg , image/jpg, image/gif, image/png',
                                                    'onchange' => 'reload_image_identity()',
                                                    'style' => 'position:absolute; width:150px; height:100px; top:0; left:0; opacity:0; ',
                                                ]) !!}
                                            </div>
                                        </div>
                                    </div>
