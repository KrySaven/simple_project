@extends('layouts.app')
@section('title',__('app.create_province'))
@section('content')
<div class="container-fluid">
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>@lang('app.create_province')</h2>
                </div> 
                <div class="body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-float">
                                <div>
                                    <label class="form-label">@lang("Province's Name English")</label>
                                </div>
                                <div class="form-line">
                                    {{Form::text('province_en_name',null,['class'=>'form-control', 'id'=>'province_en_name', 'placeholder'=>"Province's Name English"])}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-float">
                                <div>
                                    <label class="form-label">@lang("Province's Name Khmer")</label>
                                </div>
                                <div class="form-line">
                                    {{Form::text('province_kh_name',null,['class'=>'form-control', 'placeholder'=>"Province's Khmer English"])}}
