    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Edit Car Lessing</h2>

                    </div>
                    <div class="body">
                        {!! Form::model($sale, array('route' => array('sale.update', $sale->id), 'files'=>true)) !!}
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-group" style="margin-top: 15px">
                                        <input type="radio" value="parents" name="dealer_relation" id="parents" class="with-gap dealer_relation" @if($sale->dealer_relation == 'parents') checked @endif>
                                        <label for="parents" class="m-l-20">Parents</label>
                                        <input type="radio" value="brother" name="dealer_relation" id="brother" class="with-gap dealer_relation" @if($sale->dealer_relation == 'brother') checked @endif>
                                        <label for="brother" class="m-l-20">Brothers</label>
                                        <input type="radio" value="couple" name="dealer_relation" id="couple" class="with-gap dealer_relation" @if($sale->dealer_relation == 'couple') checked @endif>
                                        <label for="couple" class="m-l-20">Couple</label>
                                        <input type="radio" value="friends" name="dealer_relation" id="friends" class="with-gap dealer_relation" @if($sale->dealer_relation == 'friends') checked @endif>
                                        <label for="friends" class="m-l-20">Friends</label>
                                        <input type="radio" value="other" name="dealer_relation" id="other" class="with-gap dealer_relation" @if($sale->dealer_relation == 'other') checked @endif>
                                        <label for="other" class="m-l-20">Other ..</label>
                                    </div>
                                </div>
                               
                                <div class="form-group form-float @if($sale->dealer_relation != 'other')  hidden @endif" id="dealer_relation_other">
                                    <div class="form-line">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-group" style="margin-top: 15px">
                                        <input type="radio" value="bank" name="commission_type" id="commission_bank" class="with-gap commission_type" @if(old('commission_type') == 'bank' || $sale->commission_type == 'bank') checked @endif>
                                        <label for="commission_bank" class="m-l-20">Bank</label>
                                        <input type="radio" value="cash" name="commission_type" id="commission_cash" class="with-gap commission_type" @if(old('commission_type') == 'cash' || $sale->commission_type == 'cash') checked @endif>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        {{form::text('commission',null,['id'=>'commission','class'=>'form-control select_focus','oninput'=>'this.value=this.value.replace(/[^0-9.]/g,"");','placeholder','0.00'])}}
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        {{form::text('date',null,['class'=>'form-control datetime','placeholder'=>'From Date','id'=>'date'])}}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        {{form::text('deposit',isset($sale->deposit)?$sale->deposit*1: 0,['id'=>'deposit','class'=>'form-control select_focus','oninput'=>'this.value=this.value.replace(/[^0-9.]/g,"");','placeholder','0.00'])}}
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        {{form::text('interest',isset($sale->interest)?$sale->interest*1: 0,['id'=>'interest','class'=>'form-control select_focus','oninput'=>'this.value=this.value.replace(/[^0-9.]/g,"");','placeholder','0.00'])}}
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        {{form::text('first_payment',null,['class'=>'form-control datetime date','placeholder'=>'From Date','id'=>'first_payment'])}}
