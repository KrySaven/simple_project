...
<div class="container-fluid">
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <form id="purchase-form" enctype="multipart/form-data" autocomplete="off" action="{{ route('purchase.update',[$data['purchase']->id]) }}" method="POST">
                        ...
                        <div class="header-dropdown">
                            <div class="form-group form-float">
                                <div style="display: flex;align-items: center;">
                                    ...
                                    <input type="text" value="{{ $purchase->p_no }}" name="purchase_no" class="form-control"  readonly style="color: red; padding:5px;width:100px">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    {{ Form::text('purchase_code',$purchase->purchase_code, [
                                                        'class' => 'form-control',
                                    ...
                                    <div class="col-sm-6">
                                     ...
                                     <div class="col-sm-6">
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    {{ Form::text('source_image', $purchase->source_image, [
                                                        'class' => 'form-control',
                                ...
                                <div class="body table-responsive">
                                    <table
                                        ...
                                        <tbody id="product_row">
                                            @if ($purchaseDetail)
                                                @foreach ($purchaseDetail as $index => $item)
                                                    @include('admin.purchase_order.row_item-edit',[
                                                        'result'=> $data['purchaseDetail'],
                                                    ])
                                                @endforeach
                                            @endif
                                        </tbody>
