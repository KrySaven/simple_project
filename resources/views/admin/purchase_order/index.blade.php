        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="row clearfix" style="margin-bottom: 10px;">
                        {!! Form::open(array('route' => 'purchases' , 'method' => 'GET')) !!}
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            ...
                            {!! Form::select('supplier_id', $suppliers, (isset($supplier_id) ? $supplier_id : null), ['class' => 'form-control show-tick', 'data-live-search' => 'true'])
                            !!}
                        </div>
                                    ...
                                    <td>
                                         <div class=" user-helper-dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li><a href="{{ route('purchase.detail', ['id' => $row->id]) }}"><i class="material-icons icon_detail">library_books</i>Detail</a></li>
                                                @switch($row->status)
                                                    @case('Pending')
                                                        <li><a href="{{ route('purchase.edit', ['id' => $row->id]) }}"><i class="material-icons icon-edit">mode_edit</i>Edit</a></li>
                                                        <li><button class="verify_btn btn_at_home" type="button"  data-id="{{ $row->id }}" data-url="{{ route('purchase.verify', $row->id) }}"><i class="material-icons" style="color: #217201;">verified_user</i>Verify</button></li>
                                                        <li>
                                                        ...
                                                        @break
                                                    @case('Verified')
                                                        <li><a href="{{ route('purchase.priority',$row->id) }}"><i class="material-icons icon_detail">message</i>Priority</a></li>
                                                    @break
                                                @endswitch
                                            </ul>
                                        </div>
