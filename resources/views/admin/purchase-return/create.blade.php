        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <form id="purchase-return-form" enctype="multipart/form-data" autocomplete="off" action="{{ route('purchase_return.store') }}" method="POST">
                            @csrf
                            <div class="header">
                                <h2>@lang('app.create_purchase_return')</h2>
                                <div class="header-dropdown">
                                    <div class="form-group form-float">
                                        <div style="display: flex;align-items: center;">
                                            <label class="form-label">@lang('app.code')</label>
                                            <input type="text" value="{{ $pr_code }}" name="generate_code" class="form-control"  readonly style="color: red; padding:5px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <fieldset>
                                    <div class="body">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group form-float">
                                                    <label class="form-label">@lang('app.purchase_return_code')<span class="required"style="color:red">*</span></label>
                                                    <div class="form-line">
                                                        {{ Form::text('purchase_return_code', null, [
                                                            'class' => 'form-control',
