        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header btnAdd">
                    <h2>@lang('app.list_exchange')</h2>
                    @php
                        $UserPermision = MyHelper::UserPermision();
                        $checkisadmin = MyHelper::checkisadmin();
                    @endphp
                    @if(isset($checkisadmin) || isset($UserPermision['exchange.create']))
                        <a href="{{ route('exchange.create') }}" class="btn bg-green waves-effect">
                ...
                <div class="body">
                     <div class="row clearfix" style="margin-bottom: 10px;">
                        {!! Form::open(array('route' => 'exchanges' , 'method' => 'GET')) !!}
                        <div class="col-md-6">
                            <b>@lang('app.search')</b>
                    ...
                    <div class="table-responsive">
                            ...
                            @forelse ($exchange as $key => $row)
                                <tr>
                                    ...
                                    <div class="button_demo">
                                        <a href="{{route('exchange.edit',['id'=>$row->id])}}"><button type="button" class="btn bg-green waves-effect"><i class="material-icons" style=" top: 0px;">mode_edit</i></button></a>
                                        <a onclick="deletes(this);" urls="{{route('exchange.destroy',['id'=>$row->id])}}">
                        ...
                        <div class="col-md-12 pull-right">
                            {{ $exchange->appends(Request::get('page'))->links()}}
                        </div>
                    </div>
                </div>
            </div>
