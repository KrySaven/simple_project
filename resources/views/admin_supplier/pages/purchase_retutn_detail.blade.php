            ...
            <div class="card" id="printarea" style="padding: 10px;">
                <div class="row">
                    <div class="col-sm-12" style="text-align: center;">
                        <h3>@lang('app.product_in_problem')</h3>
                    </div>
                </div>
                {{-- @dd($purchaseReturn) --}}
                <div class="row" style="text-align: left;">
                    <div class="col-sm-6">
                        <p>@lang('app.purchase_return_code'): {{ $purchaseReturn->purchase_return_code }}</p>
                    </div>
                    <div class="col-sm-6" style="text-align: end;">
                        <p>@lang('app.purchase_return_date'): {{ $purchaseReturn->date }}</p>
                    </div>
                </div>
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="table table-responsive">
                            <table class="table table-bordered" style="white-space: nowrap;">
                                ...
                                <tbody>
                                    @if (sizeof($purchaseReturnDetail) > 0)
                                    @php($i = 1)
                                    @foreach ($purchaseReturnDetail as $item)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                    ...
                                    <tr style="background-color: #ddd;">
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th>{{ $purchaseReturn->total_qty }}</th>
                                        <th>{{ $purchaseReturn->grand_total }}</th>
                                    </tr>
                                    @endif
                                </tbody>
                            </table>
