            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row clearfix" style="margin-bottom: 10px;">
                        {!! Form::open(array('route' => 'supplier.purchaseReturnList' , 'method' => 'GET')) !!}
                        <div class="col-sm-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                 <a href="{{ route('supplier.purchaseReturnList') }}" class="btn bg-green waves-effect pull-right m-l-5" >
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                            @forelse ($purchasesReturn as $key => $row)
                                <tr>
                                    ...
                                    <td>
                                       @if ($row->purchaseReturnPDFs)
                                           <a href="{{ route('supplier.downloadPurchaseReturn',['id'=>$row->id]) }}">@lang('app.download')</a>
                                       @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class=" user-helper-dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li><a href="{{ route('supplier.purchaseReturnDetail', ['id' => $row->id]) }}"><i class="material-icons icon_detail">library_books</i>Detail</a></li>
                                                @switch($row->status)
                                                    @case('Verified')
                                                        <li>
                                                            <form method="POST" action="{{ route('supplier.acceptPurchaseReturn', ['id' => $row->id]) }}">@csrf @method('PATCH')</form>
                                                            <a onclick="accept(this)"><i class="material-icons icon_verifty">check_circle</i>Accept</a>
                                                        </li>
                                                        <li>
                                                            <form method="POST" action="{{ route('supplier.rejectPurchaseReturn', ['id' => $row->id]) }}">@csrf @method('PATCH')</form>
