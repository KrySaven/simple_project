...
class Guarantor extends Model
{
	...
	protected $fillable = [
        ...
        'identity_type',
        'guarantor_relation',
        'guarantor_relation_identity_number',
        'guarantor_relation_issued_by',
        'guarantor_relation_nationality',
        'guarantor_relation_identity_type',
        'guarantor_relation_date_of_birth',
        'guarantor_relation_identity_created_at',
        'guarantor_relation_sex',
        'guarantor_relation_name_kh',
        'guarantor_relation_name_en',
        'customer_id'
    ];
    ...
    public function getGuarantorInfoAttribute(){
    ...
    public function getGuarantorDOBAttribute(){
    ...
    public function getGuarantorRelationDOBAttribute(){
        if(!empty($this->guarantor_relation_date_of_birth)){
            return MyHelper::khMultipleNumber(date('d',strtotime($this->guarantor_relation_date_of_birth??""))) .'-'. MyHelper::khMonth(date('m',strtotime($this->guarantor_relation_date_of_birth??""))) .'-'. MyHelper::khMultipleNumber(date('Y',strtotime($this->guarantor_relation_date_of_birth??"")));
        }
    }
    public function getFullAddressGuarantorAttribute(){
